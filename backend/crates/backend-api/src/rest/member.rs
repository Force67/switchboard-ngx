...
use crate::rest::models::{ListMembersQuery, MemberResponse, UpdateMemberRoleRequest};
...
pub async fn list_members(
    ...
    let members = state
        .member_repo
        .list_by_chat_public(&chat_id, role_filter, params.limit, params.offset)
        .await
...
pub async fn update_member_role(
    ...
    // Additional checks: Only owners can promote others to owner
