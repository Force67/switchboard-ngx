...
export default function CreateInline(props: Props) {
  ...
  return (
    <div class="create-inline">
      {props.isLoading ? (
        <svg class="loading-spinner" viewBox="0 0 16 16" width="14" height="14">
          <circle cx="8" cy="8" r="6" stroke="currentColor" stroke-width="2" fill="none" stroke-dasharray="20 20" stroke-dashoffset="20">
