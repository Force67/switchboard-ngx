...
use bytes::Bytes;
use denkwerk::{ChatMessage, CompletionRequest, FunctionCall, ToolCall, ToolChoice};
use tracing::{debug, info, warn};

use crate::error::{GatewayError, GatewayResult};
use crate::rest::models::{ChatCompletionForm, ChatCompletionResponse, TokenUsage, WebSearchSource};
use crate::services::{
    create_web_search_tool, WebSearchService, WEB_SEARCH_CONTENT_INJECTION_PROMPT,
